...
The `latestReceiptInfo` method returns an array of objects containing all the transactions for the subscription,
...
:::caution
Code samples above are for guidance only. You should use maintain your own business logic.
:::
